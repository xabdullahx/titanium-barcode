...
public class MwbarcodescannerModule extends KrollModule {
	...
	protected class BarcodeResultHandler implements TiActivityResultHandler,
		...
		public void onError(Activity arg0, int arg1, Exception arg2) {
			if (errorCallback != null) {
				errorCallback.callAsync(
						(KrollObject) errorCallback,
						createErrorResponse(-1,
								"error message: " + arg2.getMessage()));
			}
		...
		public void onResult(Activity activity, int requestCode,
			...
			// Log.i("Scanner result","Result code: " +
	...
	@Kroll.method
	public int MWBregisterSDK(String key) {
		return BarcodeScanner.MWBregisterSDK(key,
	...
	@Kroll.method
	public void MWPsetActiveParser(int activeParser) {
		ScannerActivity.param_activeParser = activeParser;
	}
