...
public class BarcodeScanner {
    ...
    public static final int MWB_CFG_GLOBAL_ROTATE180 = 0x08;

    /** @brief  Global decoder flags value: calculate location for 1D barcodeTypes (Code128, Code93, Code39 supported)
      */
    public static final int MWB_CFG_GLOBAL_CALCULATE_1D_LOCATION = 0x10;
    ...
    /** @brief  Global decoder flags value: fail 1D decode if result is not confirmed by location expanding (Code128, Code93, Code39 supported)
      */
    public static final int MWB_CFG_GLOBAL_VERIFY_1D_LOCATION = 0x20;
     ...
     * 1D locaiton flags will be enabled automatically with this one
      */
    public static final int MWB_CFG_GLOBAL_USE_CENTRIC_SCANNING = 0x40;
    ...
    public static final int MWB_CODE_MASK_MAXICODE = 0x00004000;
    public static final int MWB_CODE_MASK_POSTAL = 0x00008000;
     ...
     * @{ */
    public static final int MWB_SUBC_MASK_QR_STANDARD  =     0x00000001;
    public static final int MWB_SUBC_MASK_QR_MICRO     =     0x00000002;
    /** @} */
    ...
    public static final int MWB_SUBC_MASK_C25_IATA  =        0x00000008;
    public static final int MWB_SUBC_MASK_C25_MATRIX =       0x00000010;
    public static final int MWB_SUBC_MASK_C25_COOP =         0x00000020;
    public static final int MWB_SUBC_MASK_C25_INVERTED =     0x00000040;
    /** @} */
    
    /**
    * @name Bit mask identifiers for POSTAL decoder types
    * @{ */
    public static final int MWB_SUBC_MASK_POSTAL_POSTNET  =  0x00000001;
    public static final int MWB_SUBC_MASK_POSTAL_PLANET   =  0x00000002;
    public static final int MWB_SUBC_MASK_POSTAL_IM     =    0x00000004;
    public static final int MWB_SUBC_MASK_POSTAL_ROYAL   =   0x00000008;
    ...
    public static final int MWB_SUBC_MASK_EANUPC_UPC_E1 = 0x00000010;
    /** @} */
    ...
    public native static int MWBregisterSDK(String key, Activity activity);
    ...
    public native static int[] MWBcropPreviewFrame(byte[] previewBuffer, int width, int height, int newSize);
